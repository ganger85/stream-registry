...
public class SourceResourceIT extends BaseResourceIT {
    ...
    public void testSourceCRUD() throws InterruptedException {
        ...
        sourceResource.upsertSource("streamA", sourceA);
        ...
        sourceResource.upsertSource("streamA", sourceB);

        Thread.sleep(TEST_SLEEP_WAIT_MS); // wait so that the Topology can process it and materialize to KV-Store

        List<Source> sources = sourceResource.getAllSourcesByStream("streamA");
        ...
        sourceResource.upsertSource("streamA", updatedSourceA);
        ...
        List<Source> streamWithoutSourceA = sourceResource.getAllSourcesByStream("streamA");
